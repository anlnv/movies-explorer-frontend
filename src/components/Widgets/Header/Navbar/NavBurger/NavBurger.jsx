...
const NavBurger = ({ isActive, toggleActive }) => {
  ...
  return (
    <div className={'burger-menu'}>
      <div
        className={`${isActive ? 'burger-menu__overlay burger-menu__overlay_active' : 'burger-menu__overlay'}`}
        onClick={toggleActive}>
        <div
          className={`${isActive ? 'burger-menu__wrapper burger-menu__wrapper_active' : 'burger-menu__wrapper'}`}>
          <div className={'burger-menu__content'} onClick={(e) => e.stopPropagation()}>
            <button type={'button'} className={'burger-menu__close-btn btn-hover'}
                    onClick={toggleActive} />
