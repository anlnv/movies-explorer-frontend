      ...
      <SectionContainer parent={'about-me'} mods={['fd-column', 'mod-center']}>
        ...
        <div className={'about-me__info-box'}>
          <div className={'about-me__student-wrapper'}>
            ...
            <p className={'about-me__bio'}>Я родился и живу в Саратове, закончил факультет экономики СГУ. У меня есть
              жена
            ...
            <Link className={'about-me__link link-hover'} to={ROUTER.GIT} target={'_blank'}>Github</Link>
          </div>
